...
const COORDS = {
  register: {
    ...
    rank:       { x: 2050, y: 1900, maxW: 5600,  size: 90 , align: "center"  },
    ...
    registeredByName: { x: 2400, y: 3540, maxW: 900, size: 90, align: "right" },
    registeredByCode: { x: 2400, y: 4050, maxW: 1800, size: 90, align: "right" },

...
const COORDS = {
  register: {
    ...
    code:       { x: 1700, y: 2330, maxW: 4600,  size: 90, align: "right"  },
    duration:   { x: 2400, y: 2990, maxW: 700,  size: 90, align: "right"  },
    registeredByName: { x: 2500, y: 3750, maxW: 900, size: 90, align: "right" },
